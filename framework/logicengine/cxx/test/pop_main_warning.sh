...
msglogger -d server -a app3 -s warning warning
msglogger -d server -a app4 hello
msglogger -d server -a app5 -s warning warning
msglogger -d server -a app6 hello
msglogger -d server -a app7 hello
msglogger -d server -a app8 hello
msglogger -d server -a app9 hello
msglogger -d server -a app10 hello
msglogger -d server -a app11 -s warning warning
