...
void
ma_rule_engine::init_engine(fhicl::ParameterSet const& pset)
{
...
void
ma_rule_engine::init_minimal_engine(Json::Value const& facts,
...
void
ma_rule_engine::feed(msg_t const& msg)
{
  // reaction starters
  conds_t status;
  conds_t source;
...
void
ma_rule_engine::evaluate_rules(notify_list_t& notify_status)
{
