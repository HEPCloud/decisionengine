...
void
ma_participants::add_group(string_t const& group)
{
...
void
ma_participants::add_group(string_t const& group, size_t size)
{
  groups_t::const_iterator it = groups.find(group);
...
void
ma_participants::add_participant(string_t const& group, string_t const& app)
{
...
void
ma_participants::add_participant(string_t const& app)
{
...
size_t
ma_participants::get_group_participant_count(string_t const& group) const
{
  groups_t::const_iterator it = groups.find(group);
...
size_t
ma_participants::get_participant_count() const
{
