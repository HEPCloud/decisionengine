...
runtime_require = ["DBUtils >= 2.0",
                   ...
                   "pandas >= 1.1.5, < 2.0; python_version >= '3.7' and platform_python_implementation == 'CPython'",
...
devel_req = ["setuptools >= 51.2", "setuptools-scm >= 6.0.1",
             ...
             "pytest == 6.2.5", "pytest-cov >= 2.11.1",
...
setup(
    ...
    packages=find_packages(
        where="src", exclude=("tests", "*.tests", "*.tests.*", "build.*", "doc.*")
    ),
